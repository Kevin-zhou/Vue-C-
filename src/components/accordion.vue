    ...
    <div>
        <div class="accordion"v-if="list"  v-for="item,index in list" v-bind:class="selectedIndex==index?'active':''">
            <div class="header bg-light" @click="selected(index)">
                <div class="inner f14">
                    <p class="p5">
                        <label>盘点单人：</label>{{item.stocktakeByName}}</p>
                    <p class="p5">
                        <label>盘点单时间：</label>{{filterTime(item.stocktakeStartTime)}}</p>
                    <!--<p class="p5">
                        <span>
            ...
            <div class="body bg-light">
                <ul class="shelf-list f14">
                    <li class="shelf-item flex" v-if="item.shelfStocktakeVos" v-for="li,index2 in item.shelfStocktakeVos">
                        <div>
